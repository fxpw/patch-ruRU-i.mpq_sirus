...
function ObjectiveTrackerAnimLineMixin:OnLoad()
	self.Icon:SetAtlas("UI-QuestTracker-Tracker-Check")
	self.CheckGlow:SetAtlas("UI-QuestTracker-Tracker-Check-Glow")
	self.Glow:SetAtlas("UI-QuestTracker-OBJFX-BarGlow")
end
...
function ObjectiveTrackerAnimBlockMixin:OnLoad()
	self.HeaderGlow:SetAtlas("UI-QuestTracker-OBJFX-BarGlow")
end
