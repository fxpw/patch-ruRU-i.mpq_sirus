local SIRUS_LOCALIZATION = {
	...
	["SERVER_ALERT_URL"] = {
		ruRU = "http://sirus.su/1234.html",
		enGB = "http://sirus.su/1234.html"
	},
	...
	["CONFIRM_PAID_SERVICE"] = {
		ruRU = "Вы уверены, что вы завершили изменение персонажа?",
	...
	["CHARACTER_CREATE_INFO_CLASS_DEATHKNIGHT_ROLE"] = {
		ruRU = "Роль: нанесение урона в ближнем бою или провокация противника",
		enGB = "Role: Melee DPS or Tank"
	},
	...
	["PAID_FACTION_CHANGE_TOOLTIP"] = {
		ruRU = "Щелкните, чтобы сменить фракцию.",
	...
	["ADDON_INVALID_VERSION_LABEL"] = {
		ruRU = "Модификация устарела. Нажмите для загрузки актуальной версии.",
		enGB = "This addon is out of date. Click to download an updated version."
	},
	...
	["CHARACTER_SERVICES_YOU_HAVE_BONUS"] = {
		ruRU = "У вас %d |4бонус:бонуса:бонусов;",
		enGB = "You have %d |4bonus:bonuses;"
	},
	["CLASS_INFO_WARRIOR4"] = {
	...
	["CHARACTER_CREATE_INFO_CLASS_ROGUE_SPELL1_DESC"] = {
		ruRU = "Разбойники могут наносить приемы сериями, что позволяет сделать завершающий удар поистине сокрушительным.",
	...
	["CHARACTER_CREATE_INFO_CLASS_WARRIOR_ROLE"] = {
		ruRU = "Роль: нанесение урона в бою или провокация противника",
		enGB = "Role: DPS or Tank"
	},
	...
	["CHARACTER_CREATE_INFO_CLASS_WARLOCK_ROLE"] = {
		ruRU = "Роль: нанесение урона в дальнем бою",
		enGB = "Role: Ranged DPS"
	},
	...
	["CHARACTER_CREATE_INFO_CLASS_ROGUE_ROLE"] = {
		ruRU = "Роль: нанесение урона в ближнем бою",
		enGB = "Role: Melee DPS"
	},
	["MENU_EDIT_UNDO"] = {
		ruRU = "Отменить",
	...
	["CHARACTER_CREATE_INFO_RACE_NIGHTELF_SPELL1_DESC"] = {
		ruRU = "Несмотря на потерю бессмертия, Ночные эльфы сохранили близость к природе, которая поддерживает их в час нужды. Применение способностей и заклинаний с шансом 20% восстановит вам 20 ед. силы рун, ярости, энергии или 10% от базового запаса маны (в зависимости от того, какой ресурс используется).",
		enGB = ""
	},
	...
	["CHARACTER_CREATE_INFO_RACE_SCOURGE_SPELL5_DESC"] = {
		ruRU = "Вы обращаетесь к стальной воле, которая некогда помогла вам вырваться из-под власти Короля-лича. Волевым усилием вы мгновенно развеиваете любые эффекты контроля над разумом, страха, ужаса, ошеломления и паралича.",
		enGB = ""
	},
	...
	["CHARACTER_UNDELETE_FREE"] = {
		ruRU = "Первое восстановление бесплатно",
		enGB = "The first restoration is free"
	},
	["SOUND_CHANNELS"] = {
		ruRU = "Каналы",
		enGB = "Sound Channels"
	...
	["CHARACTER_CREATE_INFO_CLASS_DRUID_ROLE"] = {
		ruRU = "Роль: нанесение урона в бою, провокация противника, или исцеление союзников",
		enGB = "Role: DPS, Tanking, or Healing."
	},
	...
	["CHARACTER_CREATE_INFO_CLASS_SHAMAN_ROLE"] = {
		ruRU = "Роль: нанесение урона в дальнем и ближнем бою, или исцеление союзников",
		enGB = "Role: Ranged or Melee DPS, or Healing"
	},
	...
	["CHARACTER_CREATE_INFO_CLASS_WARLOCK_DESC"] = {
		ruRU = "Чернокнижники уничтожают ослабленного противника, сочетая увечащие болезни и темную магию. Находясь под защитой своих питомцев, чернокнижники разят врага на расстоянии. Физически слабые колдуны не могут носить тяжелую броню, поэтому подставляют под вражеские удары своих слуг.",
	...
	["CHARACTER_CREATE_INFO_CLASS_PRIEST_ROLE"] = {
		ruRU = "Роль: лечение или нанесение урона в дальнем бою",
		enGB = "Role: Healer or Ranged DPS"
	},
	...
	["CHARACTER_CREATE_INFO_CLASS_PALADIN_ROLE"] = {
		ruRU = "Роль: нанесение урона в ближнем бою, провокация противника или исцеление союзников",
		enGB = "Role: Melee DPS, Tanking, or Healing."
	},
	["CLASS_INFO_WARRIOR3"] = {
	...
	["CHARACTER_CREATE"] = {
		ruRU = "Создать персонажа",
		enGB = "Create a character"
	},
	...
	["CHARACTER_BOOST_CHARACTER_PATTERN"] = {
		ruRU = "|c%s%s (Уровень %d %s)|r",
		enGB = "|c%s%s (Level %d %s)|r"
	},
	...
	["CHARACTER_SERVICES_BOOST_COST"] = {
		ruRU = "Цена: %d |4бонус:бонуса:бонусов;",
		enGB = "Price: %d |4bonus:bonuses;"
	},
	...
	["CHARACTER_CREATE_INFO_RACE_VOIDELF_SPELL2_DESC"] = {
		ruRU = "Бездна подпитывает вас в час нужды. Пока ваш показатель основного ресурса ниже 50%, раз в 3 сек. вы восстанавливаете 5 ед. ярости, энергии, силы рун, или 3% от базовой маны.",
		enGB = ""
	},
